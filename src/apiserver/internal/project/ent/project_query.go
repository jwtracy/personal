...
func (pq *ProjectQuery) QueryTags() *TopicQuery {
...
func (pq *ProjectQuery) WithTags(opts ...func(*TopicQuery)) *ProjectQuery {
	query := &TopicQuery{config: pq.config}
	...
	if query := pq.withTags; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(project.TagsPrimaryKey[1], fks...))
			},
