...
// The BlogPostQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type BlogPostQueryRuleFunc func(context.Context, *ent.BlogPostQuery) error

// EvalQuery return f(ctx, q).
func (f BlogPostQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.BlogPostQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.BlogPostQuery", q)
}

// The BlogPostMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type BlogPostMutationRuleFunc func(context.Context, *ent.BlogPostMutation) error

// EvalMutation calls f(ctx, m).
func (f BlogPostMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.BlogPostMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.BlogPostMutation", m)
}
